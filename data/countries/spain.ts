...
export const spain: Country = {
  ...
  description: 'Spain is a vibrant country known for flamenco dancing, bullfighting, and siesta culture. With diverse regions from the beaches of Costa del Sol to the mountains of the Pyrenees, Spain offers rich history and passionate living.',
  quickFacts: [
  ...
  history: [
    {
      year: '711-1492',
      title: 'Moorish Spain',
      description: 'Islamic rule brought architectural marvels like the Alhambra and significant advances in science and culture.'
    },
    {
      year: '1492',
      title: 'Reconquista Complete',
      description: 'Christians recaptured Granada, ending Muslim rule. Columbus discovered the Americas for Spain.'
    },
    {
      year: '16th-17th Century',
      title: 'Spanish Empire',
      description: 'Spain became a global superpower, controlling vast territories in the Americas, Europe, and Asia.'
    },
    {
      year: '1975-Present',
      title: 'Modern Democracy',
      description: 'After Franco\'s death, Spain transitioned to democracy and joined the European Union in 1986.'
    },
  ],
  innovations: [
    {
      name: 'Autogyro',
      year: '1920',
      description: 'Juan de la Cierva invented the autogyro, precursor to the modern helicopter.'
    },
    {
      name: 'Mop',
      year: '1956',
      description: 'Manuel Jalón Corominas invented the modern mop and bucket system.'
    },
    {
      name: 'Stapler',
      year: '1920',
      description: 'The modern stapler was perfected and commercialized by Spanish engineers.'
    },
    {
      name: 'Space Suit',
      year: '1935',
      description: 'Emilio Herrera designed one of the first pressurized space suit prototypes.'
    },
  ],
  mustVisit: [
    { name: 'La Sagrada Familia', description: 'Gaudí\'s masterpiece basilica in Barcelona, still under construction after 140+ years.' },
    { name: 'Alhambra', description: 'Stunning Moorish palace and fortress complex in Granada with intricate Islamic architecture.' },
    { name: 'Park Güell', description: 'Whimsical public park in Barcelona designed by Antoni Gaudí with colorful mosaics.' },
    { name: 'Prado Museum', description: 'One of the world\'s finest art museums in Madrid, featuring works by Velázquez and Goya.' },
    { name: 'Ibiza', description: 'Mediterranean island famous for beaches, nightlife, and stunning sunsets.' }
  ],
  travelEssentials: [
    { item: 'Best time to visit', description: 'May-June and September-October for good weather without extreme heat or crowds.' },
    { item: 'Siesta awareness', description: 'Many shops close 2-5 PM for siesta; plan accordingly.' },
    { item: 'Comfortable walking shoes', description: 'Spanish cities involve lots of walking and cobblestones.' },
    { item: 'Light jacket', description: 'Evenings can be cool even in summer.' },
    { item: 'Sunscreen and hat', description: 'Spanish sun is intense, especially in summer.' },
    { item: 'Basic Spanish phrases', description: '"Gracias", "Por favor", and "Hola" are appreciated.' }
  ],
  mainDish: {
    id: 'spain-main',
    name: 'Paella Valenciana',
    description: 'Traditional Spanish rice dish from Valencia with chicken, rabbit, and vegetables',
    cookingTime: 60,
    servings: 6,
    dietType: 'meat',
    ingredients: [
      ...
      { name: 'Butter beans', amount: 150, unit: 'g' },
    ...
    steps: [
      ...
      'The bottom should form a crispy layer called "socarrat"',
    ],
  ...
  dessert: {
    ...
    description: 'Crispy fried dough pastries served with thick hot chocolate for dipping',
    cookingTime: 30,
    servings: 4,
    dietType: 'vegetarian',
    ingredients: [
    ...
    steps: [
      ...
      'Pipe dough through star tip into hot oil in 6-inch strips',
  ...
  drinks: {
    alcoholic: 'Sangria, Rioja wine, Cava, Sherry',
    nonAlcoholic: 'Horchata, Café con leche, Fresh orange juice, Agua de Valencia',
  },
  music: [
    'Malagueña',
