...
export const togo: Country = {
  ...
  description: 'Togo is a narrow West African country known for palm-lined beaches, hilltop villages, and the Vodun religion.',
  quickFacts: [
  ...
  foodCulture: 'Togolese cuisine features corn, yams, cassava, and spicy sauces with West African flavors.',
  mainDish: {
    id: 'togo-main',
