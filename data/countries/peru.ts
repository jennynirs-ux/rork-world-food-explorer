...
export const peru: Country = {
  ...
  mainDish: {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1534939561126-855b8675edd7?w=650&q=80',
  },
  dessert: {
    id: 'peru-dessert',
    name: 'Alfajores',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1535399831218-d5bd36d1a6b3?w=850&q=80',
  },
  drinks: {
