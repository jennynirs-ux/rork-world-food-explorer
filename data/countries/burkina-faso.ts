...
export const burkinaFaso: Country = {
  ...
  mainDish: {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1536304993881-070802b4db5f?w=800&q=80',
  },
  dessert: {
    id: 'burkina-dessert',
    name: 'Beignets',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1567306301408-9b74779a11a2?w=800&q=80',
  },
  drinks: {
