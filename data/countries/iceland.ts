...
export const iceland: Country = {
  ...
  mainDish: {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1534080564583-6be75777b70a?w=750&q=80',
  },
  dessert: {
    id: 'iceland-dessert',
    name: 'Kleinur',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1598511726623-d2e9996892f0?w=850&q=80',
  },
  innovations: [
    {
