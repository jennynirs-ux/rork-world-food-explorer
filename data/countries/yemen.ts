...
export const yemen: Country = {
  ...
  mainDish: {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1576618148400-f54bed99fcfd?w=700&q=80',
  },
  dessert: {
    id: 'yemen-dessert',
    name: 'Bint Al-Sahn',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1596797038530-2c107229654b?w=700&q=80',
  },
  drinks: {
