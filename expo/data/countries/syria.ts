...
export const syria: Country = {
    ...
    foodCulture: {
      en: 'Syrian cuisine is rich and varied with influences from Ottoman, Persian, and Mediterranean traditions. Meals often revolve around shared mezze, grilled meats, fragrant rice dishes, and sweets scented with rose or orange blossom.',
      sv: 'Syrisk mat är rik och varierad med influenser från ottomanska, persiska och medelhavsinfluenser. Måltider kretsar ofta kring delad mezze, grillat kött, doftande risrätter och sötsaker doftande av rosor eller apelsinblomma.',
      de: 'Die syrische Küche ist reich und vielfältig mit Einflüssen aus osmanischen, persischen und mediterranen Traditionen. Mahlzeiten drehen sich oft um geteilte Mezze, gegrilltes Fleisch, duftende Reisgerichte und Süßigkeiten mit Rosen- oder Orangenblütenaroma.',
      fr: 'La cuisine syrienne est riche et variée, avec des influences des traditions ottomanes, persanes et méditerranéennes. Les repas s\'articulent souvent autour de mezze partagés, de viandes grillées, de plats de riz parfumés et de douceurs parfumées à la rose ou à la fleur d\'oranger.',
      es: 'La cocina siria es rica y variada con influencias de las tradiciones otomana, persa y mediterránea. Las comidas a menudo giran alrededor de mezze compartidos, carnes a la parrilla, platos de arroz fragantes y dulces aromatizados con rosa o flor de azahar.',
      it: 'La cucina siriana è ricca e varia con influenze dalle tradizioni ottomane, persiane e mediterranee. I pasti spesso ruotano attorno a mezze condivise, carni alla griglia, piatti di riso profumati e dolci profumati di rosa o fiori d\'arancio.',
      pl: 'Kuchnia syryjska jest bogata i zróżnicowana, z wpływami tradycji osmańskich, perskich i śródziemnomorskich. Posiłki często koncentrują się wokół dzielonych mezze, grillowanych mięs, aromatycznych dań ryżowych i słodyczy pachnących różą lub kwiatem pomarańczy.',
      nl: 'De Syrische keuken is rijk en gevarieerd met invloeden uit Ottomaanse, Perzische en Mediterrane tradities. Maaltijden draaien vaak om gedeelde mezze, gegrild vlees, geurige rijstgerechten en zoetigheid geurig van rozen of oranjebloesem.',
      pt: 'A culinária síria é rica e variada com influências das tradições otomana, persa e mediterrânea. As refeições frequentemente giram em torno de mezze compartilhadas, carnes grelhadas, pratos de arroz perfumados e doces aromatizados com rosa ou flor de laranjeira.',
    },
    history: [
      {
        year: '3000–2000 BC',
    ...
    music: [
      ...
      { en: 'Arabic classical music', sv: 'Arabisk klassisk musik', de: 'Arabische klassische Musik', fr: 'Musique classique arabe', es: 'Música clásica árabe', it: 'Musica classica araba', pl: 'Arabska muzyka klasyczna', nl: 'Arabische klassieke muziek', pt: 'Música clássica árabe' },
      { en: 'Levantine folk songs', sv: 'Levantinska folksånger', de: 'Levantinische Volkslieder', fr: 'Chansons folkloriques levantines', es: 'Canciones folclóricas levantinas', it: 'Canzoni folk levantine', pl: 'Lewantyńskie pieśni ludowe', nl: 'Levantijnse volksliederen', pt: 'Canções folclóricas levantinas' },
    ],
    decorationIdeas: [
      { en: 'Red, white, black and green flag colors', sv: 'Röd, vit, svart och grön flaggfärger', de: 'Rot, Weiß, Schwarz und Grün Flaggenfarben', fr: 'Couleurs du drapeau : rouge, blanc, noir et vert', es: 'Colores de la bandera: rojo, blanco, negro y verde', it: 'Colori della bandiera: rosso, bianco, nero e verde', pl: 'Kolory flagi: czerwony, biały, czarny i zielony', nl: 'Rood, wit, zwart en groen vlagkleuren', pt: 'Cores da bandeira: vermelho, branco, preto e verde' },
      { en: 'Damascus rose patterns', sv: 'Damaskusrosmönster', de: 'Damaszener Rosenmuster', fr: 'Motifs de rose de Damas', es: 'Patrones de rosa damascena', it: 'Motivi di rosa di Damasco', pl: 'Wzory róży damasceńskiej', nl: 'Damascus roospatronen', pt: 'Padrões de rosa damascena' },
      { en: 'Historic architecture imagery', sv: 'Historisk arkitekturbilder', de: 'Historische Architekturbilder', fr: 'Imagerie d\'architecture historique', es: 'Imágenes de arquitectura histórica', it: 'Immagini di architettura storica', pl: 'Obrazy historycznej architektury', nl: 'Historische architectuurbeelden', pt: 'Imagens de arquitetura histórica' },
      ...
      { en: 'Lanterns and warm ambient lighting', sv: 'Lyktor och varm omgivningsbelysning', de: 'Laternen und warme Umgebungsbeleuchtung', fr: 'Lanternes et éclairage d\'ambiance chaleureux', es: 'Linternas e iluminación ambiental cálida', it: 'Lanterne e illuminazione ambientale calda', pl: 'Latarnie i ciepłe oświetlenie ambientalne', nl: 'Lantaarns en warm sfeerverlichting', pt: 'Lanternas e iluminação ambiente quente' },
      { en: 'Brass and copper accents', sv: 'Mässings- och kopparaccenter', de: 'Messing- und Kupferakzente', fr: 'Accents en laiton et cuivre', es: 'Acentos de latón y cobre', it: 'Accenti in ottone e rame', pl: 'Akcenty z mosiądzu i miedzi', nl: 'Messing en koper accenten', pt: 'Acentos de latão e cobre' },
    ],
    conversationStarters: [
      { en: 'What do you know about ancient Middle Eastern history?', sv: 'Vad vet du om forntida mellanöstern historia?', de: 'Was wissen Sie über die altorientalische Geschichte?', fr: 'Que savez-vous de l\'histoire ancienne du Moyen-Orient ?', es: '¿Qué sabes sobre la historia antigua del Medio Oriente?', it: 'Cosa sai della storia antica del Medio Oriente?', pl: 'Co wiesz o starożytnej historii Bliskiego Wschodu?', nl: 'Wat weet u over de oude Midden-Oosterse geschiedenis?', pt: 'O que você sabe sobre a história antiga do Oriente Médio?' },
      { en: 'Have you tried Levantine cuisine?', sv: 'Har du provat levantisk mat?', de: 'Haben Sie levantinische Küche probiert?', fr: 'Avez-vous essayé la cuisine levantine ?', es: '¿Has probado la cocina levantina?', it: 'Hai provato la cucina levantina?', pl: 'Czy próbowałeś kuchni lewantyńskiej?', nl: 'Heb je Levantijnse keuken geprobeerd?', pt: 'Você já experimentou a culinária levantina?' },
      { en: 'Are you more into food, history, or architecture when you explore a country?', sv: 'Är du mer intresserad av mat, historia eller arkitektur när du utforskar ett land?', de: 'Interessieren Sie sich mehr für Essen, Geschichte oder Architektur, wenn Sie ein Land erkunden?', fr: 'Êtes-vous plus attiré par la nourriture, l\'histoire ou l\'architecture lorsque vous explorez un pays ?', es: '¿Te interesa más la comida, la historia o la arquitectura cuando exploras un país?', it: 'Sei più interessato al cibo, alla storia o all\'architettura quando esplori un paese?', pl: 'Czy bardziej interesujesz się jedzeniem, historią czy architekturą podczas zwiedzania kraju?', nl: 'Ben je meer in eten, geschiedenis of architectuur als je een land verkent?', pt: 'Você se interessa mais por comida, história ou arquitetura quando explora um país?' },
      { en: 'Have you ever tried mezze-style dining with many small dishes?', sv: 'Har du någonsin provat mezze-stil matande med många små rätter?', de: 'Haben Sie jemals Mezze-Stil-Essen mit vielen kleinen Gerichten probiert?', fr: 'Avez-vous déjà essayé la restauration style mezze avec de nombreux petits plats ?', es: '¿Has probado alguna vez la comida estilo mezze con muchos platos pequeños?', it: 'Hai mai provato il pasto in stile mezze con molti piccoli piatti?', pl: 'Czy próbowałeś kiedyś jedzenia w stylu mezze z wieloma małymi daniami?', nl: 'Heb je ooit mezze-stijl eten met veel kleine gerechten geprobeerd?', pt: 'Você já experimentou jantar no estilo mezze com muitos pequenos pratos?' },
    ],
    quiz: [
      {
        id: 'syria-q1',
